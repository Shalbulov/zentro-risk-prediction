        ...
        const mockData: RegionData[] = [
          {
            ...
            color: "#ff671b", // Mastercard orange
            latLng: [45, 78]
          },
          {
            id: "nur-sultan",
    ...
    return (
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
        ...
        <button
          ...
          className="mx-auto mt-2 block rounded-lg bg-orange-500 px-4 py-2 text-white hover:bg-orange-600"
        >
          Попробовать снова
        </button>
      </div>
        ...
        <div className="h-0 pb-[60%]">
          <div className="absolute inset-0 flex items-center justify-center">
            <CountryMap
              ...
              mapColor="#e3dfd7" // Mastercard light gray
